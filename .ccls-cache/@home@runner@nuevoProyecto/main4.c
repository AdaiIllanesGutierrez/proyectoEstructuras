...
//FUNCIONES PARA LA LIMPIEZA DE LA PANTALLA 
...
//FUNCIONES DE VERIFICACION DE LA FECHA 
...
//FUNCION PARA SOLICITAR LA FECHA 
...
//Esta funcion agregara las tareas a la lista y mapas 
            ...
            switch (opcionModificar) {
                ...
                case '3':
                    ...
                    if (tarea->dificultad < 1 || tarea->dificultad > 5) {
                        printf("Dificultad inválida, debe ser un valor entre 1 y 5\n");
                        tarea->dificultad = 3; // Restablecer a el valor por defecto en caso de entrada inválida
                    }
                    break;
                default:
